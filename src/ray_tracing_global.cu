...
struct Sphere;
__global__ void ray_tracing ( unsigned char* , Sphere* );
...
int main( int argc, char *argv[] ) {
    ...
    HANDLE_ERROR( cudaMemcpy(dev_s, host_s,
    ...
    ray_tracing <<< dimGrid, dimBlocks >>> (dev_bitmap, dev_s);
...
__global__ void ray_tracing (unsigned char *ptr, Sphere *s) {
